...
public class PrometeoEditor : Editor{
  ...
  private SerializedObject SO;
    ...
    //
    //
    private SerializedProperty enableControl;
  ...
  private SerializedProperty steeringSpeed;
    private SerializedProperty steeringCurve;
  private SerializedProperty brakeForce;
    private SerializedProperty handbrakeForce;
  ...
  private void OnEnable(){
    ...
    SO = new SerializedObject(target);
        ...
        enableControl = SO.FindProperty("enableControl");
    ...
    steeringSpeed = SO.FindProperty("steeringSpeed");
        steeringCurve = SO.FindProperty("steeringCurve");
    brakeForce = SO.FindProperty("brakeForce");
        handbrakeForce = SO.FindProperty("handbrakeForce");
  ...
  public override void OnInspectorGUI(){
    ...
    GUILayout.Space(10);
        ...
        //
        //
        enableControl.boolValue = EditorGUILayout.Toggle("Enable Player Control", enableControl.boolValue);
    ...
    steeringSpeed.floatValue = EditorGUILayout.Slider("Steering Speed:", steeringSpeed.floatValue, 0.1f, 1f);
        steeringCurve.animationCurveValue = EditorGUILayout.CurveField("Steering Curve:", steeringCurve.animationCurveValue);
    brakeForce.intValue = EditorGUILayout.IntSlider("Brake Force:", brakeForce.intValue, 100, 1600);
        handbrakeForce.intValue = EditorGUILayout.IntSlider("Handbrake Force:", handbrakeForce.intValue, 100, 1600);
